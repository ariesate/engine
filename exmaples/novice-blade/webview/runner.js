...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__packages_controller_novice_src__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__output_mods_keyboard__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__output_components__ = __webpack_require__(256);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
function renderConfigToFlatTree(config, components) {
  ...
  const Com = _extends({}, RawCom, {
    getDefaultState() {
      return _extends({}, RawCom.getDefaultState(), config.props);
    }
  });
  return Object(__WEBPACK_IMPORTED_MODULE_0__packages_controller_novice_src__["b" /* createElement */])(
    Com,
    { bind: 'child' },
    config.children.map(child => renderConfigToFlatTree(child, components))
  );
}
...
const Runner = {
  ...
  render({ state }) {
    ...
    return renderConfigToFlatTree(state.config, __WEBPACK_IMPORTED_MODULE_2__output_components__["a" /* default */]);
  }
};

window.controller = Object(__WEBPACK_IMPORTED_MODULE_0__packages_controller_novice_src__["c" /* render */])(Object(__WEBPACK_IMPORTED_MODULE_0__packages_controller_novice_src__["b" /* createElement */])(Runner, { bind: 'runner' }), document.getElementById('root'), { keyboard: __WEBPACK_IMPORTED_MODULE_1__output_mods_keyboard__ });
