...
const dirNames = fileNames.filter(name => !/\./.test(name) && name !== HOOKS_DIR_NAME && !notComponentDir.includes(name) && !commandLikeComponents.includes(name) && name !== ICON_DIR_NAME)
